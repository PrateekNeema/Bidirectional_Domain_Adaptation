...
class BaseAgent(object):
    ...
    def __init__(self, config):
        ...
        # Load Dataset
        self._load_datasets()     ###this will call load CDS agent datset when caled in its object

        self._create_model()      ####this creates resnet50 and our cosine classifer model
    ...
    def train(self):
        ...
        :return:
        """
        if self.config.validate_freq:        ### 1
            self.validate()
